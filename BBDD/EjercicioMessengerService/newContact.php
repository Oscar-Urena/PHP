...
if(isset($_SESSION["usuario"])){
    ...
    $stmt = $con->prepare("SELECT iduser, name, nick FROM users WHERE iduser != :yo AND iduser NOT IN ( SELECT idcontact FROM contacts WHERE iduser = :yo)");
    $stmt->bindValue(":yo", $idUsuario, PDO::PARAM_INT);
    $stmt->execute();
